{/* TODO: Notes on how to create docs for template */}
{/* 1. **Introduction to the Template Engine** */}
{/*    - Overview of the template engine */}
{/*    - Purpose and key features */}
{/* */}
{/* 2. **Guide to Building Templates** */}
{/*    - Basic concepts and components */}
{/*    - Using HTML for styling templates */}
{/*    - Creating a basic template step-by-step */}
{/* */}
{/* 3. **Input Data** */}
{/*    - Types of input data the template accepts */}
{/*    - How to structure and provide input data */}
{/* */}
{/* 4. **Output Data** */}
{/*    - Types of output data the template generates */}
